...
def render_top_hero(total_available: int) -> None:
    st.markdown(
        f"""
        <div class="hero-shell">
          <div class="hero-kicker">Forensic Medicine · Slide quiz</div>
          <div class="hero-title">Forensic Slides Quiz</div>
          <div class="hero-subtitle">
            نسخة أكثر احترافية وهدوءًا من الاختبار، مع واجهة أوضح، ترتيب أفضل، ومؤقت مباشر يظهر للمستخدم
            من 30 إلى 0 لزيادة الحماس والتركيز.
          </div>
        </div>
        """,
        unsafe_allow_html=True,
    ...
    with stat_cols[0]:
        st.markdown(
            f"""
            <div class="mini-stat">
              <div class="label">Available slides</div>
    ...
    with stat_cols[1]:
        st.markdown(
            f"""
            <div class="mini-stat">
              <div class="label">Timer mode</div>
    ...
    with stat_cols[2]:
        st.markdown(
            ...
            <div class="mini-stat">
              ...
              <div class="value">Cleaner UI</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
...
def render_start_screen() -> None:
    ...
    render_top_hero(total_available)
        ...
        st.markdown(
            ...
            <div class="panel-shell">
              ...
              <div class="section-caption">
                • مساحة بيضاء أنظف وتباين أعلى.<br>
                • بطاقات للأسئلة والإجابات بدل شكل Streamlit الافتراضي الخام.<br>
                • مؤقت مباشر يوضح الوقت المتبقي للمستخدم بشكل واضح.<br>
                • يدعم نفس قاعدة الأسئلة والصور الموجودة عندك.
              </div>
            </div>
            """,
            unsafe_allow_html=True,
    ...
    with right:
        st.markdown(
            """
            <div class="panel-shell">
              <div class="section-title">Quiz setup</div>
              <div class="section-caption">Choose the number of slides and turn the timer on if you want the challenge mode.</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
    ...
    st.markdown(
        ...
        <div class="panel-shell">
          ...
          <div class="section-caption">
            1) Choose the number of slides.<br>
            2) Read the image and the prompt.<br>
            3) Type your answer and submit it.<br>
            4) Compare your answer with the model answer and move to the next slide.
          </div>
        </div>
        """,
        unsafe_allow_html=True,
...
def render_question_screen() -> None:
    ...
    question_cols = st.columns([1.15, 0.85], gap="large")
    ...
    with question_cols[1]:
        st.markdown(
            ...
            <div class="panel-shell">
              ...
              <div class="section-caption">
                Slide <strong>{current_q + 1}</strong> of <strong>{total_q}</strong><br>
                File: <code>{html.escape(current_slide)}</code>
              </div>
            </div>
            """,
            unsafe_allow_html=True,
