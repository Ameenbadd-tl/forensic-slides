...
SLIDES_DATA = {
    ...
    "img73.jpg": {"q": "Identify the type of hair and describe its medulla and cortex.", "a": "Animal hair أ¢â‚¬â€œ thick medulla & thin cortex"},
    ...
    "img118.jpg": {"q": "Identify the condition and the cause of death.", "a": "Impaction of food in the oropharyngeal (Cafآ© Coronary). + choking death : asphyxia or cardiac arrest"},
    ...
    "img148.jpg": {"q": "Identify the type of hair and describe its medulla and cortex.", "a": "Human hair أ¢â‚¬â€œ Absent medulla & thick cortex"},
}
...
def render_timer_widget(start_ts: float, duration: int = TIMER_SECONDS) -> None:
    ...
    <div id="timer-root" class="timer-shell timer-safe">
      <div class="timer-top">
        <div class="timer-heading">Live timer / ط§ظ„ظ…ط¤ظ‚طھ ط§ظ„ظ…ط¨ط§ط´ط±</div>
...
def render_top_hero() -> None:
    st.markdown(
        ...
        <div class="hero-shell">
          ...
          <div class="hero-subtitle">ط§ط®طھط¨ط§ط± ط´ط±ط§ط¦ط­ ط§ظ„ط·ط¨ ط§ظ„ط´ط±ط¹ظٹ ظ…ط¹ ظ…ط¤ظ‚طھ 30 ط«ط§ظ†ظٹط© ظˆط¹ط±ط¶ ظ†ط¸ظٹظپ ظ…ظ†ط§ط³ط¨ ظ„ظƒظ„ ط§ظ„ط£ط¬ظ‡ط²ط©.</div>
        </div>
        """,
        unsafe_allow_html=True,
    )
